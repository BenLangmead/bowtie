...
static void printLongUsage(ostream& out) {
	...
	"                     was reported to a file with name <filename>.  Dumped reads will appear the same as they did in the input; any trimming or transformations of quality values within Bowtie will not be reflected.\n"
	"                     Paired-end reads will be written to two parallel\n"
	"                     files with \"_1\" and \"_2\" inserted in the filename,\n"
