 ...
 * host.
 */
void writeU32(std::ostream& out, uint32_t x, bool toBigEndian) {
 ...
 * endianness.
 */
void writeU32(std::ostream& out, uint32_t x) {
 ...
 * host.
 */
void writeI32(std::ostream& out, int32_t x, bool toBigEndian) {
 ...
 * endianness.
 */
void writeI32(std::ostream& out, int32_t x) {
	out.write((const char*)&x, 4);
}
 ...
 * if necessary.
 */
uint32_t readU32(std::istream& in, bool toBigEndian) {
	uint32_t x;
	in.read((char *)&x, 4);
 ...
 * if necessary.
 */
int32_t readI32(std::istream& in, bool toBigEndian) {
	int32_t x;
	in.read((char *)&x, 4);
	assert_eq(4, in.gcount());
